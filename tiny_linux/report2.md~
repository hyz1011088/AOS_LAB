...
3. 内核态运行
    ...
    ./1
    生成结果如下：
    ![image](https://github.com/hyz1011088/AOS_LAB/tiny_linux/pic/1.png)
     
    可以发现，1文件不能运行，提示权限不够！

    接着创建在目录下创建/trusted文件夹，并将1文件拷贝到该文件夹下运行，结果如下：
    ![image](https://github.com/hyz1011088/AOS_LAB/tiny_linux/pic/2.png)
...
4. 检查网络连接
    ...
    ![image](https://github.com/hyz1011088/AOS_LAB/tiny_linux/pic/3.png)
