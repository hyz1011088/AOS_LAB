...
```
###生成bin/kernel
   首先生成 kernel.ld init.o readline.o stdio.o kdebug.o kmonitor.o panic.o clock.o console.o intr.o picirq.o trap.o trapentry.o vectors.o pmm.o  printfmt.o string.o kernel.ld，下面是这些文件到的生成方式
   obj/kern/*/*.o 
...
|	|
| 当bootblock、kernel均生成时，就可以生成ucore.img文件里
| 生成ucore.img的相关代码为
